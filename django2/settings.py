...
#pedindo pro django simular que eu estou enviando um email
#equanto minha aplicacao ainda nao esta pronta e print esse email no console pra me.
#EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'

#se sua aplicacao ja estiver pronta , use essas config
